...
-- Provide safe mapgen aliases that are always valid, independent of load order.
-- The gameplay arena is generated by this mod, so mapgen materials are not used.
